...
| Environments, secrets and early rejection | [SEC-001 to SEC-006, SEC-008/009](specs/environments-and-security.md#accepted-goals) | Static identities/access and credential rotation accepted; decide source format, trust, recovery/rollback, renewal failure and transport enforcement before the security milestone. | Planned; no live user-management subsystem; cryptographic architecture remains open. |
...
| Runtime lifecycle, evolution and scale | [Open runtime contracts](specs/system-model.md#open-runtime-and-delivery-contracts), [SYS-006](specs/system-model.md#accepted-platform-boundaries) | Agree resource ownership, control/retry semantics, compatibility and numeric workload budgets before dependent I/O/distributed implementation. | Measurement gate accepted; recommendations and thresholds remain open. |
| Creator capability/resource guidance | [Proposed UI journeys](specs/creator.md#planned-capability-and-resource-guidance) | Agree interactions with the corresponding Step/module, observation and resource contracts; test comprehension, accessibility and bounded UI work. | Proposed; no new UI or runtime metric contract implemented. |
